...
describe("base old tests", function () {
  ...
  it("deploy LizardFactory and test pair length", async function () {
    const LizardFactory = await ethers.getContractFactory("LizardFactory");
    factory = await LizardFactory.deploy();
    await factory.deployed();

    expect(await factory.allPairsLength()).to.equal(0);
  });

  it("deploy LizardRouter01 and test factory address", async function () {
    const LizardRouter01 = await ethers.getContractFactory("LizardRouter01");
    router = await LizardRouter01.deploy(factory.address, owner.address);
    await router.deployed();

    expect(await router.factory()).to.equal(factory.address);
  });

  it("deploy pair via LizardFactory owner", async function () {
  ...
  it("deploy pair via LizardFactory owner2", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
    const mim_1 = ethers.BigNumber.from("1000000000000000000");
    const dai_1 = ethers.BigNumber.from("1000000000000000000");
  ...
  it("LizardRouter01 addLiquidity", async function () {
  ...
  it("LizardRouter01 removeLiquidity", async function () {
    const ust_1000 = ethers.BigNumber.from("100000000000");
    const mim_1000 = ethers.BigNumber.from("100000000000000000000000");
    const mim_100000000 = ethers.BigNumber.from("100000000000000000000000000");
    const dai_100000000 = ethers.BigNumber.from("100000000000000000000000000");
  ...
  it("LizardRouter01 addLiquidity owner2", async function () {
    const ust_1000 = ethers.BigNumber.from("100000000000");
    const mim_1000 = ethers.BigNumber.from("100000000000000000000000");
    const mim_100000000 = ethers.BigNumber.from("100000000000000000000000000");
    const dai_100000000 = ethers.BigNumber.from("100000000000000000000000000");
  ...
  it("LizardRouter01 pair1 getAmountsOut & swapExactTokensForTokens", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
  ...
  it("LizardRouter01 pair1 getAmountsOut & swapExactTokensForTokens owner2", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
    const route = {from: ust.address, to: mim.address, stable: true}
  ...
  it("LizardRouter01 pair2 getAmountsOut & swapExactTokensForTokens", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
  ...
  it("LizardRouter01 pair3 getAmountsOut & swapExactTokensForTokens", async function () {
  ...
  it("deploy LizardVoter", async function () {
    ...
    const LizardVoter = await ethers.getContractFactory("LizardVoter");
    voter = await LizardVoter.deploy(ve.address, factory.address, gauges_factory.address, bribe_factory.address);
  ...
  it("deploy Minter", async function () {
    ...
    const Minter = await ethers.getContractFactory("LizardMinter");
  ...
  it("deploy LizardFactory gauge", async function () {
  ...
  it("deploy LizardFactory gauge owner2", async function () {
    const pair_1000 = ethers.BigNumber.from("1000000000");
  ...
  it("LizardRouter01 pair1>pair2 getAmountsOut & swapExactTokensForTokens", async function () {
    const mim_1 = ethers.BigNumber.from("1000000000000000000");
    const route = [{from: mim.address, to: ust.address, stable: false}, {
      from: ust.address,
      to: mim.address,
  ...
  it("LizardRouter01 addLiquidity owner3", async function () {
  ...
  it("deploy LizardFactory gauge owner3", async function () {
    const pair_1000 = ethers.BigNumber.from("1000000000");
